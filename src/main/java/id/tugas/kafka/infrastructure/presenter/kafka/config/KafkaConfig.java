package id.tugas.kafka.infrastructure.presenter.kafka.config;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic bobaTopic() {
        String bobaTopic = "boba";
        return new NewTopic(bobaTopic, partitionNumber, (short) replicationFactor);
    }
}
