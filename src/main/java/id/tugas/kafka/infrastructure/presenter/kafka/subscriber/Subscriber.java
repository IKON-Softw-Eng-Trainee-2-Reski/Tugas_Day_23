package id.tugas.kafka.infrastructure.presenter.kafka.subscriber;
...
public class Subscriber {
    ...
    @KafkaListener(topics = "boba", concurrency = "${spring.kafka.consumer.level.concurrency:3}")
    public void subscribeBoba(@Payload String message){
        log.info("[boba] received message: " + message);
    }
}
